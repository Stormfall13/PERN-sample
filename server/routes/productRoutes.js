...
router.post("/", async (req, res) => {
    try {
        const { nameProd, description, price, categoryId, brand, images, sizes, colors, stock, isHit, isNew, isSale } = req.body;
...
router.put("/:id", async (req, res) => {
    try {
        const { id } = req.params;
        const { nameProd, description, price, categoryId, brand, images, stock, isHit, isNew, isSale } = req.body; // `image` теперь строка
